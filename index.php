...
?>
      <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <table align="center">
          <tr><td colspan="2">ismini gir baam!</td></tr>
          <tr><td>Nick: </td>
...
<meta http-equiv="Content-Type" content="text/HTML; charset=utf-8" />
   <title>swantex anonim sohbet grubu</title>
...
<body onload="UpdateTimer();">
    <div id="main">
      <div id="caption">anonim sohbet grubu</div>
      <div id="icon">&nbsp;</div>
<?php 
    ...
    ?>
     ...
     ?>
      ...
      <div id="sender" onkeyup="keypressed(event);">
         ...
         <button onclick="doWork();">Guver baam</button>
      </div>   
<?php            
    }
